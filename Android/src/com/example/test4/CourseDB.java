...
public class CourseDB {
	...
	private final CourseOpenHelper mDatabaseOpenHelper;
	private static final HashMap<String,String> mColumnMap = buildColumnMap();
	
	public CourseDB(Context context) {
        mDatabaseOpenHelper = new CourseOpenHelper(context);
    }
	...
	public Cursor getCourse(String rowId, String[] columns) {
	...
	public Cursor getCourseMatches(String query, String[] columns) {
	 ...
	 private static class CourseOpenHelper extends SQLiteOpenHelper {
	        ...
	        private void loadCourse() throws IOException {
	            ...
	            InputStream inputStream = resources.openRawResource(R.raw.course);
	            Log.d(TAG, "1");
	            ...
	            try {
	                ...
	                while ((line = reader.readLine()) != null) {
	                    ...
	                    long id = addCourse(result[0].trim(), result[1].trim());
	                    if (id < 0) {
	                        Log.e(TAG, "unable to add course: " + result[0].trim());
	                    }
	                }
	            } finally {
	                reader.close();
	            }
	            Log.d(TAG, "DONE loading courses.");
	        }
	         ...
	         */
	        public long addCourse(String name, String details) {
